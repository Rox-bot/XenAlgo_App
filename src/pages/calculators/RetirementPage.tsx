...
import { TrendingUp, DollarSign, Clock, Percent, Target, PiggyBank } from 'lucide-react';
...
const RetirementPage = () => {
  ...
  useEffect(() => {
    calculateRetirement();
  }, [currentAge, retirementAge, monthlyInvestment, expectedReturn, inflationRate]);
  ...
  const calculateRetirement = () => {
    ...
    const maturityAmount = monthlyInvestment * (((Math.pow(1 + monthlyRate, monthsToRetirement) - 1) / monthlyRate) * (1 + monthlyRate));
    const totalInvestment = monthlyInvestment * monthsToRetirement;
    ...
    <CalculatorLayout title="Retirement Planning Calculator">
      <div className="space-y-8">
              ...
              <Card className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-blue-500/20">
                <CardContent className="p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-muted-foreground">Retirement Corpus</span>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Retirement Fund Growth</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">

            ...
            <CardContent className="p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.symbol && <p className="text-sm text-red-500 mt-1">{errors.symbol}</p>}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.entry_price && <p className="text-sm text-red-500 mt-1">{errors.entry_price}</p>}
                </div>
          ...
          <Card>
            <CardContent className="p-4 space-y-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="riskManagement" className="font-medium">Risk Management</Label>
              </div>
          ...
          <Card>
            <CardContent className="p-4 space-y-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="setupDetails" className="font-medium">Setup Details</Label>
              </div>
          ...
          <Card>
            <CardContent className="p-4 space-y-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="imageUpload" className="font-medium">Upload Screenshots (Max 2)</Label>
              </div>
